const productos = [
    {
        id: "01",
        imagen: "../imagenes/p1Gestion.jpg",
        alt: "Muestra flechas de interaccion entre procesos",
        nombre: "Gestión",
        precio: 20000
    },
    {
        id: "02",
        imagen: "../imagenes/p2Procesos.jfif",
        alt: "Muestra flechas de interaccion entre procesos",
        nombre: "Procesos",
        precio: 30000
    },
    {
        id: "03",
        imagen: "../imagenes/p3Analisis.png",
        alt: "Muestra graficamente como es el analisis",
        nombre: "Analisis",
        precio: 10000
    },    
    {
        id: "04",
        imagen: "../imagenes/p5Implementacion.png",
        alt: "Muestra como implementar Sistemas",
        nombre: "Implementación",
        precio: 40000
    },    
    {
        id: "05",
        imagen: "../imagenes/p4planificacionEstrategica.jpg",
        alt: "grafica como es la planificacion Estrategica",
        nombre: "Planificacion",
        precio: 33000
    },  
    {
        id: "06",
        imagen: "../imagenes/p6Mantenimiento.png",
        alt: "Muestra como mantener un Sistema",
        ...
        divProductos.insertAdjacentHTML("afterbegin",
            ...
            <div class="producto">
                ...
                <div class="producto-contenido">
                    ...
                    <button class="btn-comprar" type="button" data-id="${producto.id}">Contratar </button>
                </div>
            </div>
            `
        );
...
function actualizarCarritoHTML() {
    ...
    carritoCompras.innerHTML = `
        <h2>Carrito para Compras de Servicios</h2>
    ...
    if (carrito.length === 0) {
        listaCarrito.innerHTML = "<p>No tienes servicios por comprar!</p>";
    } else {
        for (let i = 0; i < carrito.length; i++) {
            ...
            li.innerHTML = `
                ...
                <div>
                    <button class="btn-cantidad" data-id="${item.id}" data-action="restar">DISMINUIR</button>
                    <button class="btn-cantidad" data-id="${item.id}" data-action="sumar">AGREGAR</button>
                    <button class="btn-eliminar" data-id="${item.id}" data-action="eliminar">BORRAR ITEM</button>
                </div>
            `;
    ...
    carritoCompras.querySelector(".cantidad-carrito").textContent = `Servicios seleccionados en el carrito: ${cantidadProductosUnicos}`;
